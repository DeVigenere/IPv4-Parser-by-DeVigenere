#include "pch.h"
#include "C:\Users\user\source\repos\PARSER2\PARSER2/subnet_filter.h"
#include "C:\Users\user\source\repos\PARSER2\PARSER2/range_filter.h"
#include "C:\Users\user\source\repos\PARSER2\PARSER2/and_filter.h"
#include "C:\Users\user\source\repos\PARSER2\PARSER2/factory_filter.h"
#include "C:\Users\user\source\repos\PARSER2\PARSER2/create_filter.cpp"
#include "C:\Users\user\source\repos\PARSER2\PARSER2/process_stream.cpp"
...
TEST(BrokenDataTest, InvalidCreateFilterFormats) {
    EXPECT_THROW(create_filter({ {"type", "subnet", "value"} }), std::runtime_error);
    EXPECT_THROW(create_filter({ {"type", "subnet"} }), std::runtime_error);
    EXPECT_THROW(create_filter({ {"wrong", "subnet", "value", "fawatafa"} }), std::runtime_error);
    EXPECT_THROW(create_filter({ {"type", "sanya228", "value", "pepe"} }), std::runtime_error);
    EXPECT_THROW(create_filter({}), std::runtime_error);
}
